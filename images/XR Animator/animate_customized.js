...
// Startup calibration imports a temporary MAX + Full Body MediaPipe profile
// before the native worker starts, then restores saved settings after real 100%.
...
(() => {
  ...
  for (const file of scripts) {
    document.write('<script src="' + base + '/' + file + '"></scr' + 'ipt>');
  }
})();
