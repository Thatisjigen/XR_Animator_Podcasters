(() => {
  ...
  const H = {
    ...
    'Protocol': ['Protocollo di rete VMC: UDP per software desktop locali, WebSocket per browser o connessioni remote.', 'none'],
    'Send avatar data': ['Trasmette le pose delle ossa e i blendshape facciali del modello 3D.', 'low'],
    'Send camera data': ['Trasmette la posizione e rotazione della telecamera virtuale 3D.', 'tiny'],
    'Host': ['Indirizzo IP di rete verso cui trasmettere i dati VMC.', 'none'],
    'Port': ['Porta di rete per la trasmissione dei dati VMC.', 'none'],
